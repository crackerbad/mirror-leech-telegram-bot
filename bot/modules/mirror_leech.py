...
from bot.helper.ext_utils.bot_utils import is_url, is_magnet, is_gdrive_link, get_content_type, new_task, sync_to_async
...
'''
    ...
    if not isQbit and not is_magnet(link) \
